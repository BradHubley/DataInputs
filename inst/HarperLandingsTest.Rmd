...
# annual TAC table
TAC = data.frame(Year=1988:2025,TAC=c(3200,3200,3200,3200,3200,3200,1500,850,850,850,850,850,1000,1150,1150,1300,1300,1375,1475,1475,1475,1700,1850,1850,2128,2447,2563,2738,3149,3621,4164,4789,5507,5445,4807, 4744, 4927, 5149)) ##update each year

# 21B start year
ystart =1960

# 21A last year(assessment year)
yend=2024 ##DOES THIS CHANGE??
...
Canada = merge(merge(data.frame(Year=1960:2024), nafoCDN3,all=T), nafoCDN4,all=T) ##CHANGE TO 2023???
Foreign  = merge(merge(data.frame(Year=1960:2024), nafoForeign3,all=T), nafoForeign4,all=T) ##CHANGE TO 2023???
