...
```{r}
CanUSPropB<-read.csv(file.path(datadir,"Regional_Proportions_Biomass2.csv"))

with(CanUSPropB,tapply(Proportion,Index_Region,mean))
```
...
HSRandom_Index_3NOP<-StratifiedRandomSurveyIndex(datadir=datadir,yrs=2017:2022, output = 'stratified.estimate', select.strata=c(41, 42, 43, 44, 51, 52, 53))
 HSRandom_Index_NRA<-StratifiedRandomSurveyIndex(datadir=datadir,yrs=2017:2024, output = 'stratified.estimate', AltArea="NRA")
 HSRandom_Index_SPM<-StratifiedRandomSurveyIndex(datadir=datadir,yrs=2017:2022, output = 'stratified.estimate', AltArea="SPM")
 
 
 library(mratios)
pSPM<- ttestratio(HSRandom_Index_SPM$B,HSRandom_Index$B)
...
pUS<-ttestratio(CanUSPropB$Index_Estimate[CanUSPropB$Index_Region=="USA"],CanUSPropB$Total_Estimate[CanUSPropB$Index_Region=="USA"])
pCan<-ttestratio(CanUSPropB$Index_Estimate[CanUSPropB$Index_Region=="Canada"],CanUSPropB$Total_Estimate[CanUSPropB$Index_Region=="Canada"])
