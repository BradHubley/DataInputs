...
get_data(db='marfis',data.dir=datadir,fn.oracle.username = uid, fn.oracle.password = pwd, fn.oracle.dsn = 'ptran',usepkg='roracle')
...
ObserverData<-ObsData(datadir=datadir,by.sex=T, bins=bins)
 ...
 LL = 50:51
  ...
  obsNAFO3OT1=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo3&GEARCD_ID==OT),bins=bins, Yrs = Yrs1)
  BarPlotLF(obsNAFO3OT1,yrs=Yrs1,rel=T,filen=file.path(wd,"figures","obsNAFO3OT1"))

  obsNAFO3OT2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo3&GEARCD_ID==OT),bins=bins, Yrs = Yrs2)
  BarPlotLF(obsNAFO3OT2,yrs=Yrs2,rel=T,filen=file.path(wd,"figures","obsNAFO3OT2"))

  obsNAFO3LL1=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo3&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs1)
  BarPlotLF(obsNAFO3LL1,yrs=Yrs1,rel=T,filen=file.path(wd,"figures","obsNAFO3LL1"))

  obsNAFO3LL2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo3&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs2)
  BarPlotLF(obsNAFO3LL2,yrs=Yrs2,rel=T,filen=file.path(wd,"figures","obsNAFO3LL2"))

  obsNAFO4OT1=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4&GEARCD_ID==OT),bins=bins, Yrs = Yrs1)
  BarPlotLF(obsNAFO4OT1,yrs=Yrs1,rel=T,filen=file.path(wd,"figures","obsNAFO4OT1"))

  obsNAFO4OT2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4&GEARCD_ID==OT),bins=bins, Yrs = Yrs2)
  BarPlotLF(obsNAFO4OT2,yrs=Yrs2,rel=T,filen=file.path(wd,"figures","obsNAFO4OT2"))

  obsNAFO4LL1=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs1)
  BarPlotLF(obsNAFO4LL1,yrs=Yrs1,rel=T,filen=file.path(wd,"figures","obsNAFO4LL1"))

  obsNAFO4LL2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs2)
  BarPlotLF(obsNAFO4LL2,yrs=Yrs2,rel=T,filen=file.path(wd,"figures","obsNAFO4LL2"))
 ...
 nafo4VW = c("4VB", "4VC", "4VN", "4VS", "4W", "4WD", "4WE", "4WF", "4WG", "4WH", "4WJ", "4WK", "4WL", "4WM")
  ...
  obsNAFO4XLL2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4X&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs2)
  BarPlotLF(obsNAFO4XLL2,yrs=Yrs2,rel=T,filen=file.path(wd,"figures","obsNAFO4XLL2"))

  obsNAFO4VWLL2=constructLF(LFdata=subset(ObserverData,NAFAREA_ID%in%nafo4VW&GEARCD_ID%in%LL),bins=bins, Yrs = Yrs2)
...
obs4x20<-subset(ObserverData,NAFAREA_ID%in%nafo4X&GEARCD_ID%in%LL&YEAR==2020)
obs4x19<-subset(ObserverData,NAFAREA_ID%in%nafo4X&GEARCD_ID%in%LL&YEAR==2019)

obs4x19<-subset(ObserverData,NAFAREA_ID=='5ZJ'&GEARCD_ID%in%LL&YEAR==2019)
...
SpatialHub::bioMap(xlim = xl, ylim = yl, mapRes="MR")
with(subset(ObserverData,NAFAREA_ID=='5ZJ'&GEARCD_ID%in%LL&YEAR==2020),points(LONGITUDE,LATITUDE,pch=16,cex=1,col=rgb(1,0,0,0.2)))
