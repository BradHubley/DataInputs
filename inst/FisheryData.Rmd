...
write.csv(table1,file.path(datadir,"MARFIS_nafo_month_2002-2011.csv"),row.names=F)
write.csv(table2,file.path(datadir,"MARFIS_nafo_month_2012-2021.csv"),row.names=F)
