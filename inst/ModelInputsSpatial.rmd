...
RVinputs4X<-prepRVdata(RVdata,years=1970:2025,strat= Strata4X,bins=bins, raw=T)
...
RVinputs4VW<-prepRVdata(RVdata,years=1970:2025,strat= Strata4VW,bins=bins, raw=T)
...
BubblePlotLF(NSRV_Lengths4X,bins=bins,yrs=1970:2025,path=file.path(wd,'figures'),filen='RVSurvey4X',inches=0.1)
BubblePlotLF(NSRV_Lengths4VW,bins=bins,yrs=1970:2025,path=file.path(wd,'figures'),filen='RVSurvey4VW',inches=0.1)
```
...
NLRV_males1<-read.csv(file.path(wd,"datafolder","NLsurvey_mfu_LF_obs.csv"))
