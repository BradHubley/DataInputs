...
```{r}
  ...
  with(subset(HSRandom_Index_WZS,Year==Current.Year),c(mean3_biomass,mean3_biomass-KgPKHse*1.96,mean3_biomass+KgPKHse*1.96))/2 #q-adjusted
...
HCR(value) #F in healthy zone in HCR function is 0.1044 not just 0.104
