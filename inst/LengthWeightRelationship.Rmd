...
# library(sqldf)
# 
# test_hal <- hal_allrmNAwt %>%
#   select(FISH_ID, FISH_LENGTH, FISH_WEIGHT)
# 
# test_hal$out<-0
...
# 
# #identify outliers
# mod1<-nls(FISH_WEIGHT~a*FISH_LENGTH^b,data=test_hal,start=c(a=.001,b=3),na.action=na.omit)
...
# test_lenwt.dat.all<-test_hal[,c(1:6)]
