...
nafoB=get_21B(count="others",ystart,yend,type=1, datadir=file.path(datadir,"Landings"))
#nafoB=get_21Bdh(count="others",ystart,yend,type=1, datadir=datadir)
# unique(nafoB$Division)
nafoBdiv = get_21B(count="others",ystart,yend,type=2,datadir=file.path(datadir,"Landings"))
