...
mtext("Model input data: 2014 version - 2021 version", outer=T, line=0.5, side=2, cex=1.5)
dev.off()
```
...
text(1.5,180, "D", cex=2 )
mtext("Year", outer=T, line=2, side=1, cex=1.5)
mtext(" 2014 model input data - 2021 online 21B ", outer=T, line=0.5, side=2, cex=1.5)
dev.off()
