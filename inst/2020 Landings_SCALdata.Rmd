...
nafoA = get_21A(count="others", yearstart = ystart, datadir=file.path(datadir,"Landings"))  #1970
sort(unique(nafoA$Year))

nafoB=get_21Bdh(count="others",ystart,yend,type=1, datadir=file.path(datadir,"Landings_2025update"))
#nafoB=get_21Bdh(count="others",ystart,yend,type=1, datadir=datadir)
# unique(nafoB$Division)
nafoBdiv = get_21Bdh(count="others",ystart,yend,type=2,datadir=file.path(datadir,"Landings_2025update"))
...
nafoBprev= read.csv(file.path(datadir,"Landings","nafoBprevious.csv"), header=T) 
...
## Scal format of 21B  
nafoBg = get_21B(count="others",ystart,yendB,type=4,datadir=file.path(datadir,"Landings"))

# import scal data from 2014 assessment
scal=read.table(file.path(datadir,"scal","scal_catch.dat"), header=F)
...
## grouping gears. trawls(12, 16 for otterTrawl) , longline (51),  others(handline, seine, gillnet,angling, spear)
  ...
  div<-c("3N","3O","3P","4VN","4VS","4W","4X","5Z","5Y")
  mar2=NULL
