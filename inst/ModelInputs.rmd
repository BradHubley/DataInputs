...
LLNafo3_unsexed<-getNAL(portNAFO3LL,sex=0)+getNAL(obsNAFO3LL,sex=0)
...
OTNafo3_unsexed<-getNAL(portNAFO3OT,sex=0)+getNAL(obsNAFO3OT,sex=0)
...
# bubble for doc
```{r}
combinedLengths<-list(Fishery_Lengths$LLNafo3_combined,Fishery_Lengths$LLNafo4_combined,Fishery_Lengths$OTNafo3_combined,Fishery_Lengths$OTNafo4_combined,NSRV_Lengths$NSRV_combined,HSFixed_Lengths$HSFixed_combined,HSRandom_Lengths$HSRandom_combined)
names(combinedLengths)<-c("LL_NAFO3","LL_NAFO4","OT_NAFO3","OT_NAFO4","RV_4VWX","HS_Fixed","HS_Random")
