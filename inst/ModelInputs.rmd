...
NSRV_Lengths<-list(NSRV_males=RVinputs$NSRV_males,NSRV_females=RVinputs$NSRV_females,NSRV_combined=RVinputs$NSRV_combined)
...
```{r}
  ...
  HSFixed_Lengths<-list(HSFixed_males=HSFixed_males,HSFixed_females=HSFixed_females,HSFixed_combined=HSFixed_combined)
  ...
  HSRandom_Lengths<-list(HSRandom_males=HSRandom_males,HSRandom_females=HSRandom_females,HSRandom_combined=HSRandom_combined)
  
  HSRandom_Index<-data.frame(Year=2017:2020,Index=  c(2.204668e-05, 3.263344e-05, 3.004447e-05, 1.819697e-05), se=c( 1.075617e-06, 1.291483e-06, 1.437159e-06, 8.738080e-07))
...
Fishery_Lengths<-list(LLNafo4_males=LLNafo4_males,LLNafo4_females=LLNafo4_females,LLNafo4_combined=LLNafo4_combined, LLNafo3_males=LLNafo3_males,LLNafo3_females=LLNafo3_females,LLNafo3_combined=LLNafo3_combined, OTNafo4_males=OTNafo4_males,OTNafo4_females=OTNafo4_females,OTNafo4_combined=OTNafo4_combined, OTNafo3_males=OTNafo3_males,OTNafo3_females=OTNafo3_females,OTNafo3_combined=OTNafo3_combined) 
...
BubblePlotLF(NLRV_Lengths,bins=seq(0,250,5),yrs=1996:2019,path=file.path(wd,'figures'),filen='NLRVSurvey',inches=0.3)
