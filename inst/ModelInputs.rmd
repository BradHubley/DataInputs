...
RVIndex<-StratifiedRandomRVSurveyIndex(RVdata[[2]])


RVinputs<-prepRVdata(RVdata,bins=bins,years=1970:2025, raw=T)
...
```{r}
  ...
  HSRandom_Index<-StratifiedRandomSurveyIndex(datadir=datadir,yrs=2017:AY,use.calc.weight = F)
