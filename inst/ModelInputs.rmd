...
# Mar.datawrangling::get_data_custom(schema="observer", data.dir = datadir, tables = c("ISFISHLENGTHS","ISSAMPLES"), usepkg = "roracle", fn.oracle.dsn= "PTRAN", fn.oracle.username=uid, fn.oracle.password =pwd,force.extract=T)
...
```{r}
  ...
  HSFixed_Index<-FixedSurveyIndex(datadir=datadir,yrs=1998:2020)
