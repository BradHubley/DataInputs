...
plot(NPT~year,NSRV_Index, ylab="Number / tow", xlab = '', ylim=c(0,max(NPT)*1.2), type='b',pch=16,xlim=c(1970,2021),xaxt='n')
axis(1,lab=F)
...
plot(KgPKH~Year,subset(HSFixed_Index,Year<2022),type='b',pch=16,col='red',ylim=c(0,250),xlim=c(1998,2021), ylab="Kg / 1000 hooks")
