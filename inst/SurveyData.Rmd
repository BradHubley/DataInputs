...
plot(KgPKH~Year,HSFixed_Index,type='b',pch=16)
lines(mean3_biomass~Year,HSFixed_Index,col='red')


HSFixed_Index_old<-FixedSurveyIndex(datadir=datadir,yrs=2000:2021,old.model=T)
...
for(i in 1:7){
  temp<-FixedSurveyIndex(datadir=datadir,yrs=2000:(2021-i),old.model=T)
...
#HSRandom_Index<-StratifiedRandomSurveyIndex(datadir=datadir,yrs=2017:2020)
