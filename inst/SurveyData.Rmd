...
source(file.path(wd, ".directories"))
...
FixedSurvey<-FixedSurveyData(datadir=datadir,LF.from = "ISFISH",by.sex=F)
FixedSurvey2<-FixedSurveyData(datadir=datadir,LF.from = "ISFISHLENGTHS",by.sex=F)
...
```{r}
    ...
    BarPlotLF(fixedLF,yrs=Yrs,rel=F,filen=file.path(wd,"figures","fixedLF1"),ymax=320)
    BarPlotLF(fixedLF2,yrs=Yrs,rel=F,filen=file.path(wd,"figures","fixedLF2"),ymax=320)
