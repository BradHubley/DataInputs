...
RandomSurvey1$diff_weight<-abs(with(RandomSurvey1,EST_COMBINED_WT -calc_weight ))

RandomSurvey2$diff_count<-abs(with(RandomSurvey2,EST_NUM_CAUGHT -NUM_MEASURED ))
RandomSurvey2$diff_weight<-abs(with(RandomSurvey2,EST_COMBINED_WT -calc_weight ))

subset(RandomSurvey1,diff_count>1&YEAR==2021)
subset(RandomSurvey2,diff_count>1&YEAR==2021)
