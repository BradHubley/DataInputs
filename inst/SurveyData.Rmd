...
# get_data_custom(schema="observer", data.dir = datadir, tables = c("ISGEARSUCCESS"), usepkg = "roracle",                                     fn.oracle.dsn= "PTRAN", fn.oracle.username=uid, fn.oracle.password =pwd)


#get_data_custom(schema="isdb",data.dir=datadir,tables=c("ISGEARSUCCESS"),usepkg="roracle",fn.oracle.dsn="PTRAN",fn.oracle.username=uid,fn.oracle.password=pwd)
...
RandomSurveyRaph<-RandomSurveyData(sp=30,datadir=datadir,by.sex=F,add.LF=T,bins=bins,hook.data=T)

FixedSurveyRaph<-FixedSurveyData(sp=30,datadir=datadir,by.sex=F,add.LF=F, bins=bins,hook.data=T)
RandomSurveyRaph<-RandomSurveyData(sp=30,datadir=datadir,add.gear=F,add.LF=T,bins=bins,by.sex=F,hook.data=T)

FixedSurveyRaph<-FixedSurveyData(datadir=datadir,by.sex=F,add.LF=F, bins=bins)
