...
source(file.path(wd, "directories.r"))
...
FixedSurvey<-FixedSurveyData(datadir=datadir,by.sex=T, bins=bins)
FixedSurvey2<-FixedSurveyData(datadir=datadir,LF.from = "ISFISH",by.sex=T)
