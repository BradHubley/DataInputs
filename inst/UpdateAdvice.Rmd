...
RVinputs4VSW<-prepRVdata(RVdata,strat=strata4VSW,bins=bins,years=c(1970:2020,2023), raw=T)
...
#4X
BubblePlotLF(NSRV_Lengths4X,bins=bins,yrs=1970:2023,path=file.path(wd,'figures'),filen='NLRVSurvey4X',inches=0.3)
...
#4VSW
BubblePlotLF(NSRV_Lengths4VSW,bins=bins,yrs=c(1970:2020,2023),path=file.path(wd,'figures'),filen='NLRVSurvey4VSW',inches=0.3)

nsrvl<-revNAL(NSRV_Lengths4VSW[-3])
YrsObs =c(1994:2020,2023) 
