...
```{r}
#RVinputs$Index
png(file.path(wd,'figures',"ModelindicesSSR.png"), width =8, height = 6,units='in',pointsize=12, res=300,type='cairo')
par(mfcol=c(2,1), mar = c(0,4,0,0.5), omi = c(0.5, 0.25, 0.5, 0.25),las=1)

plot(NPT~year,subset(NSRV_Index,year!=2021), ylab="Number / tow", xlab = '', ylim=c(0,max(NPT)*1.2), type='o',pch=16,xlim=c(1970,Current.Year),xaxt='n')
axis(1,lab=F)
