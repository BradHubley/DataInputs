...
#png(file.path(wd,'figures',"Landings2025.png"), width =9, height = 6,units='in',pointsize=12, res=300,type='cairo')
...
#  png(file.path(wd,'figures',"SRBiomass2025.png"), width =9, height = 6,units='in',pointsize=12, res=300,type='cairo')
...
#png(file.path(wd,'figures',"Mortality2025.png"), width =9, height = 6,units='in',pointsize=12, res=300,type='cairo')
  ...
  U<-(L$ts.value[L$ts.name=="CanadaTotal"]+L$ts.value[L$ts.name=="ForeignTotal"])/(B$ts.value*1000) #total landings divided by HS_3yrm*1000
  f<- log(1-U)*-1 
  points(B$year,f,pch=16) #make points of x=B$year, y=f ??
...
#png(file.path(wd,'figures',"Recruitment2025.png"), width =9, height = 6,units='in',pointsize=12, res=300,type='cairo')
...
xl=c(-68,-47)
yl=c(40,48)
png(file.path(wd,'figures',"SurveyMap2025.png"), width =8, height = 6,units='in',pointsize=12, res=300,type='cairo')
...
sp::plot(NAFO,add=T)
 points(lat.DecDeg~lon.DecDeg,HalSurvey2025,pch=21,bg = "red",cex=0.5)
...
```{r}
blob1=readRDS(file.path("fsardata", "MSEoutput","sim_base.rds"))

plotHCR(list(blob1))

blob2=readRDS(file.path("fsardata", "MSEoutput","sim_parBatpostCSASgrid3.rds"))

plotHCR(list(blob2))


png(file.path('Outputs','SARfigures',"HCRfr.png"), width =6000, height = 4000, res = 600)
plotHCR(list(blob1),lang='fr')
dev.off()
