...
[Mandatory bullet(s)]
The LRP is 0.4 BMSY = 10.9 kt and the USR is 0.8 BMSY = 21.8 kt. The 2024 biomass from the Stratified Random Halibut Survey was estimated using a catchability of 0.002 to be XX kt(95% confidence interval: XX, XX). Based on the three-year mean, the exploitable biomass index from the Stratified Random Halibut Survey for 2024 is XX kt which is XX BMSY, and substantially higher than the USR, putting this stock in the healthy zone. - text from the document
:::
...
::: {custom-style="fsar-bullet"}
[Mandatory bullet(s)] 
The biomass index from the previous Fixed Station Halibut Survey (1998-2022) peaked in 2018 and the three-year mean peaked in 2020, followed by a decline in the final two years of that survey. - maybe removing reference to Fixed Station?

There have been minimal inter-annual changes in the exploitable biomass index from the Stratified Random Halibut Survey (2017-2024)? The three-year mean remained relatively stable with a XX (slight increase) in 2024?

"Inter-annual changes in the exploitable biomass index have been smaller for the Stratified Random Halibut Survey compared with the Fixed Station Halibut Survey. The three-year mean remained relatively stable with a XX (slight increase?) in 2024." - what's in the document now; maybe removing reference to Fixed Station

The DFO Maritimes Region Summer Ecosystem Survey (RV Survey; NAFO Divs. 4VWX) provides an a recruitment index for Atlantic halibut. The catch of Atlantic Halibut in this survey increased between 2000 and 2011, followed by a decline, but has been increasing in recent years. The index for 2024 is the XXth highest value in the time series.
...
::: {custom-style="fsar-bullet"}
[Mandatory bullet(s)]
As the 2024 three-year mean exploitable biomass based on the Stratified Random Halibut Survey is higher than 1.2BMSY (XX kt), the highest fishing mortality, 1.2 FMSY(0.104), would be applied using the articulated harvest control (decision?) rule. This results in a TAC advice (recommended removal) for 2025-2026 of XXXX t. This assumes all removals from Canadian and international fisheries are included. - basically the harvest control section of the text...separate? reduce?

TAC advice of XXXX t is within the maximum annual change of 15% from the 2024-02025 TAC. 
...
Additionally, an abundance index cannot be estimated for 2021 because the RV Survey was completed using a new vessel with a new fishing net and the conversion factor has not been developed (Figure XX - in the 4 panel). - disregard making a comment on this year? Or comment that following completion of comparative fishing between the old and new vessels, a convertion factor for Atlantic halibut was estimated (1:1) and data from the 2021 survey that was not included in previous years has now been incorporated into the time series.

The abundance index for 2024 is the XX highest value in the time series. The length composition and the index of abundance are reviewed annually, exclusively for context and do not directly contribute to the HCR outputs.
