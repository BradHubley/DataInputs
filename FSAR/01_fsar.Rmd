...
HalSurvey2024 <- read.csv("./data/2024 Halibut Longline Survey Stations Assigned.csv")
completed2024 <- read.csv("./data/2024 Halibut Longline Survey Stations Completed.csv")
