...
In March 2022, the Scotia-Fundy Groundfish Advisory Committee (SFGAC) adopted an articulated harvest control rule (HCR) based on the index of exploitable biomass from the stratified Random Halibut Survey (Figure 1), Although reference points have been defined based on SSB, reference points and control points for the HCR use the Stratified Random Halibut Survey biomass that correspond to SSB (LRP = 0.4B~MSY~, USR = 0.8 B~MSY~, and 1.2B~MSY~, Table 1) (@DFO2024a) . 
...
```
Figure 2. (A) Catch and Total Allowable Catch, (B) Halibut Survey Biomass (B) in relation to the Limit Reference Point (LRP; 10.9 kt) and Upper Stock Reference (USR; 21.8 kt), (C) Fishing and Natural Mortality in relation to the F~MSY~ Removal References (D) Recruitment index from the RV survey in numbers.
