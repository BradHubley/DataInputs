...
![Figure 1. The articulated harvest decision rules with reference points and control points used for determining target harvest rates for Atlantic Halibut based on biomass estimates from the Stratified Random Industry-DFO Halibut Longline Survey. LRP = limit reference point, USR = upper stock reference, F = fishing mortality rate, LCP = limit control point, B~MSY~ = Biomass at maximum sustainable yield.](fsardata/HCR.png)
